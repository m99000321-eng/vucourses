  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-100 flex flex-col font-sans" dir="rtl">
      ...
      <div className="flex-1 max-w-7xl w-full mx-auto flex">
        <Sidebar role="STUDENT" activeTab="settings" />
            ...
            <h2 className="text-sm font-bold text-slate-800 dark:text-slate-200 flex items-center gap-2">
             ...
             <div className="flex items-center justify-between p-4 bg-slate-50 dark:bg-slate-800 rounded-xl">
               <div className="space-y-1">
                 <p className="text-xs font-bold text-slate-800 dark:text-slate-200">{t('darkMode')}</p>
                 <p className="text-[11px] text-slate-500">{t('darkModeDescription')}</p>
              </div>
              <button
                onClick={toggleTheme}
          ...
          <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-6 shadow-sm space-y-4">
            <h2 className="text-sm font-bold text-slate-800 dark:text-slate-200 flex items-center gap-2">
             ...
             <div className="space-y-3">
               <div className="flex items-center justify-between p-4 bg-slate-50 dark:bg-slate-800 rounded-xl">
                 <div className="space-y-1">
                   <p className="text-xs font-bold text-slate-800 dark:text-slate-200">{t('platformNotifications')}</p>
                   <p className="text-[11px] text-slate-500">{t('platformNotificationsDescription')}</p>
                </div>
                <button
              ...
              <div className="flex items-center justify-between p-4 bg-slate-50 dark:bg-slate-800 rounded-xl">
                <div className="space-y-1">
                   <p className="text-xs font-bold text-slate-800 dark:text-slate-200">{t('emailNotifications')}</p>
                   <p className="text-[11px] text-slate-500">{t('emailNotificationsDescription')}</p>
                </div>
                <button
          ...
          <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-6 shadow-sm space-y-4">
            <h2 className="text-sm font-bold text-slate-800 dark:text-slate-200 flex items-center gap-2">
             ...
             <form onSubmit={handleChangePassword} className="space-y-3">
               <div>
                 <label className="block text-xs font-bold text-slate-700 dark:text-slate-300 mb-1">{t('currentPassword')}</label>
                <input
                  type="password"
              ...
              <div>
                 <label className="block text-xs font-bold text-slate-700 dark:text-slate-300 mb-1">{t('newPassword')}</label>
                <input
                  type="password"
              ...
              <div>
                 <label className="block text-xs font-bold text-slate-700 dark:text-slate-300 mb-1">{t('confirmPassword')}</label>
                <input
                  type="password"
